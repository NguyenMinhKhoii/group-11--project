...
router.get(
  "/analytics",
  checkRole(["admin"]),
  ActivityLogController.getSecurityAnalytics
);
...
router.get(
  "/ip/:ipAddress",
  checkRole(["admin"]),
  ActivityLogController.getLogsByIP
);
...
router.get(
  "/ratelimit/:ipAddress",
  checkRole(["admin"]),
  ActivityLogController.checkRateLimit
);
...
router.get(
  "/dashboard",
  checkRole(["admin"]),
  ActivityLogController.getActivityDashboard
);
